...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'glasmetropolen-leads' ),
				'storm'       => __( 'Storm or hail damage', 'glasmetropolen-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'glasmetropolen-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'glasmetropolen-leads' ),
				'not-sure'    => __( 'Vet inte än', 'glasmetropolen-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'glasmetropolen-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'glasmetropolen-leads' ),
				'research' => __( 'Jag kollar bara priser', 'glasmetropolen-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'glasmetropolen-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'glasmetropolen-leads' ),
		'contacted' => __( 'Kontaktad', 'glasmetropolen-leads' ),
		'quoted'    => __( 'Quote sent', 'glasmetropolen-leads' ),
		'won'       => __( 'Won', 'glasmetropolen-leads' ),
		'lost'      => __( 'Lost', 'glasmetropolen-leads' ),
		'spam'      => __( 'Misstänkt spam', 'glasmetropolen-leads' ),
	);
}
